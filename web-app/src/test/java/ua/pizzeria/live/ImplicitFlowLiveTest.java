...
public class ImplicitFlowLiveTest {
    ...
    private final static String AUTH_SERVER = "http://localhost:8081/oauth-server";
    private final static String RESOURCE_SERVER = "http://localhost:8082/web-app";
    ...
    public void givenUser_whenUseFooClient_thenOkForFooResourceOnly() {
        ...
        final Response fooResponse = RestAssured.given().header("Authorization", "Bearer " + accessToken).get(RESOURCE_SERVER + "/user");
